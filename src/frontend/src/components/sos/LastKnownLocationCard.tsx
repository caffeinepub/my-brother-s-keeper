          ...
          <div className="space-y-3">
            ...
            <Alert>
              <AlertDescription className="text-xs">
                ⚠️ This is a one-time snapshot, not real-time tracking. Location
                was captured at the time shown above.
              </AlertDescription>
            </Alert>
          </div>
        ) : (
