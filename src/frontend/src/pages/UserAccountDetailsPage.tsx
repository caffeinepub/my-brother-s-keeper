...
export default function UserAccountDetailsPage() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useGetUserAccountDetails(principal);
        ...
        <AdminRouteGuard>
          <div className="space-y-6 max-w-6xl">
            ...
            <Alert variant="destructive">
              ...
              <AlertDescription>
                {error?.message ||
                  "Failed to load user account details. The user may not exist."}
              </AlertDescription>
            </Alert>
          </div>
        </AdminRouteGuard>
        ...
        <div className="space-y-6 max-w-6xl">
          ...
          {emergencyProfile && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  This information is accessible via Emergency Lookup with the
                  user's access code
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    Access code has been generated. Emergency contacts can view
                    this information using the user's Principal ID and access
                    code.
                  </AlertDescription>
                </Alert>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Safe places contributed by this user
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {recentRoutes.length === 0 ? (
                ...
                <div className="space-y-3">
                  {recentRoutes.map((route) => (
                    <div
                      key={`${route.start}-${route.destination}-${String(route.dateTime)}`}
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {lastLocations.map((loc, idx) => (
                        // biome-ignore lint/suspicious/noArrayIndexKey: location has no unique id
                        <TableRow key={idx}>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {activityLog.map((entry, idx) => (
                        // biome-ignore lint/suspicious/noArrayIndexKey: entry has no unique id
                        <TableRow key={idx}>
                          <TableCell>
