...
import { Check, CheckCircle, Copy, Shield, XCircle } from "lucide-react";
              ...
              {isAdmin && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    You have administrative privileges and can access the admin
                    dashboard.
                  </p>
                </div>
              )}
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  This is your unique identifier on the Internet Computer. Keep
                  it safe and share it only with trusted contacts.
                </p>
              </div>
            </CardContent>
          </Card>
