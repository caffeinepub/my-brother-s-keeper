      ...
      <div className="space-y-6 max-w-2xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Capture your location for emergency situations
          </p>
        </div>
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            This captures a one-time location snapshot, not real-time tracking.
            Anyone with your Principal ID + Emergency Access Code can view it
            via Emergency Lookup.
          </AlertDescription>
        </Alert>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            >
              ...
              {isCapturing || createSnapshot.isPending
                ? "Capturing Location..."
                : "Capture SOS Location"}
            </Button>
