  ...
  const features = [
    {
      ...
      description:
        "Discover and share trusted stops — hotels, restaurants, mechanics, and more vetted by the community.",
    },
    {
      icon: Route,
      title: "Route Sharing",
      description:
        "Share your planned routes with fellow riders so others know your path and can coordinate meetups.",
    },
    {
      icon: Users,
      title: "Meetup Coordination",
      description:
        "Share your real-time location with trusted riders for easy meetup coordination on the road.",
    },
    {
      icon: AlertTriangle,
      title: "Emergency SOS",
      description:
        "One-tap emergency snapshot shares your location. Trusted contacts can look you up anytime.",
    },
    {
      icon: Shield,
      title: "Verified Members",
      description:
        "Upload your trucking license and ID for community verification and trusted status.",
    },
    {
      icon: ShieldCheck,
      title: "Community Safety",
      description:
        "Built on the Internet Computer for decentralized, censorship-resistant safety infrastructure.",
    },
  ];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 md:py-32 text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            The community safety network for long-haul truckers and riders. Stay
            connected, stay safe, and help each other on the road.
          </p>
      ...
      <section className="bg-primary/5 border-t border-border">
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Sign in to access all features — share routes, coordinate meetups,
            and keep your emergency profile up to date.
          </p>
          <Button
            size="lg"
            onClick={() => navigate({ to: "/places" })}
      ...
      <footer className="border-t border-border bg-background">
        <div className="container mx-auto px-4 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            />
            <span>
              © {new Date().getFullYear()} MBK Riders. All rights reserved.
            </span>
          </div>
          <a
