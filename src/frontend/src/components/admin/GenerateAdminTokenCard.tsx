  ...
  const handleGenerate = async () => {
    try {
      ...
      toast.success("Admin token generated", {
        description:
          "Share this token with the user you want to promote to admin. It expires in 3 days.",
      });
    } catch (err: any) {
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <CardDescription className="text-xs">
              Create a one-time token to promote another user to admin. Valid
              for 3 days.
            </CardDescription>
          </div>
        </div>
        ...
        {generatedToken ? (
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Share this token with the user. It can only be used once and
              expires in 3 days.
            </p>
            <Button
              size="sm"
